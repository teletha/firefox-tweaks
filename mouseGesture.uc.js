...
var ucjsMouseGestures = {
  ...
  commands :
      ...
      [
        ...
        ['', '[次へ]等のリンクへ移動', function(){ ucjsNavigation?.advancedNavigateLink(1); } ],
        ['', '[戻る]等のリンクへ移動', function(){ ucjsNavigation?.advancedNavigateLink(-1); } ],

        ['U', 'リロード', function(){ document.getElementById("Browser:Reload").doCommand(); } ],
        ['', 'リロード(キャッシュ無視)', function(){ document.getElementById("Browser:ReloadSkipCache").doCommand(); } ],
        ...
        ['', 'タブを閉じる', function(){ document.getElementById("cmd_close").doCommand(); } ],
        ...
        ['D', '閉じたタブを元に戻す', function(){ document.getElementById("History:UndoCloseTab").doCommand(); } ],
        ...
        ['', '上端へスクロール', function(){ goDoCommand("cmd_scrollTop"); } ],
        ['', '下端へスクロール', function(){ goDoCommand("cmd_scrollBottom"); } ],
        ...
        ['DUD', '再起動', function(){ ucjsMouseGestures_helper.restart(); } ],
        ...
        ['DU', 'アドオンマネージャ', function(){ openTrustedLinkIn("about:addons", "tab", {inBackground: false, relatedToCurrent: true}); } ],
